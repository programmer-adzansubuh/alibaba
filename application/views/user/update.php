    ...
    <div class="col-12">
        <div class="page-header">
            <a class="my-auto" href="<?= base_url('user') ?>"><i class="icon ion-md-arrow-back"></i> back</a>
                <h4 class="page-title my-auto ml-2"> &#8212; Update <?= $title; ?></h4>
            <a href="<?= base_url('user') ?>" class="btn btn-secondary ml-auto"><i class="icon ion-md-close-circle"></i>Cancel</a>
        </div>
    </div>

    <div class="col-12 grid-margin">
        <form class="form-sample" method="post" action="<?= base_url('user/update') ?>">
            <div class="card">
                <div class="card-body">
                    <div class="row mt-4">
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" id="email" name="email" placeholder="you@email.com"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label  text-lg-right">Reset Password</label>
                                <div class="col-sm-9">
                ...
                <div class="card-footer">
                    <div class="float-right">
                        <button type="submit" class="btn btn-success"><i class="icon ion-md-checkmark-circle"></i>Save Changes</button>
                    </div>
                </div>
            </div>
        </form>
...
<script>
    ...
    $(document).ready(function () {
        $('#fullname').focus();
        $('#role').val(<?= $user['user_role_id'] ?>);
        const active = <?= $user['user_status'] ?>;
        if (active === 1) {
